...
export const studentsData: Omit<Student, "code" | "group">[] = [
  ...
  { id: "220569461", firstName: "נעם", lastName: "יחיאב", birthDate: "29.08.2012", grade: "ז", address: "היוגבים 7/9", city: "ראשון לציון", motherName: "עמית", fatherName: "אוהד", motherPhone: "052-2325271", fatherPhone: "050-8787034", motherEmail: "amit.yehiav@ppd.com", fatherEmail: "ohad.yhv@gmail.com", gender: "נ" },
