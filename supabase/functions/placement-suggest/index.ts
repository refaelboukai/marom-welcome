...
serve(async (req) => {
  ...
  try {
    const { student, classes } = await req.json();
...
שיקולים (בסדר משקל): (1) גיל/כיתה קרובים לתלמידי הכיתה, (2) פרופיל רגשי-חברתי-למידתי דומה או משלים, (3) איזון מגדרי בכיתה, (4) חפיפה חיובית של חוזקות ואתגרים עם ילדים ספציפיים בכיתה, (5) הימנעות מעומס — אל תערום ילדים בסיכון גבוה בכיתה אחת.
