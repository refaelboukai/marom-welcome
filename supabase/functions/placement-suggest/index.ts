...
שיקולים (בסדר משקל):
(0) סיכום מילולי על התלמיד (narrativeSummary) — אם קיים, זהו מקור מידע איכותני ראשון במעלה שנכתב על ידי צוות/מומחה. יש להסיק ממנו רבדים אישיים, היסטוריה, אתגרים ייחודיים, נקודות רגישות ודינמיקות שלא עולים מהשאלונים. יש לצטט/לפרפרז אותו ברציונל.
