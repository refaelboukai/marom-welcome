...
במקום לפזר פריטים בודדים — קבץ אותם ל-4-6 קטגוריות תמטיות (למשל: "ויסות רגשי", "חוסן ומסוגלות", "מיומנויות חברתיות", "ריכוז ולמידה", "דימוי עצמי", "יחסים במשפחה"). לכל קטגוריה — הסבר מורחב, פרקטיקות עבודה קונקרטיות, ותלמידים ספציפיים שנוגעים בה.
